...
export default class ProductA extends Component {
  constructor(props) {
    ...
    this.state = {
      product: {
        images: [
          require('../../assets/patches/Leukocyte/1.png'),
          require('../../assets/patches/Leukocyte/2.png'),
          require('../../assets/patches/Leukocyte/3.png'),
          require('../../assets/patches/Leukocyte/4.png'),
          require('../../assets/patches/Leukocyte/5.png'),
        ],
        name: 'Leukocyte',
        description:
          'Leukocyte is a product of white blood cells — is detected in your urine, it may be a sign of a urinary tract infection. Leukocytes may also be found in a urinalysis, or a urine test. The detection of white blood cells in the urine suggests a possible UTI. High levels of white blood cells in your urine also suggest that you have an infection.\n\nInfections or obstruction in the urinary tract or bladder may cause you to have an increased amount of leukocytes in your urine. Infections may be more severe if you’re pregnant, which increases the odds of developing problems such as urinary tract infections (UTIs). If you’re pregnant and have an infection in your urinary tract, it’s important to receive treatment because it could complicate your pregnancy.\n\nYou’re at risk for developing a bacterial infection in your bladder if you hold your urine too long before relieving yourself. Repeatedly holding in urine can stretch the bladder too much. Over time, that makes your bladder less likely to empty fully when you go to the bathroom. When urine remains in the bladder, it raises the chances that bacteria will increase in number, which may lead to a bladder infection. Uncomplicated cystitis is another name for a urinary infection that’s limited to the bladder in healthy people who aren’t pregnant. Kidney stones, a tumor in the pelvis, or some other type of blockage in the urinary tract may also cause more leukocytes to appear.\n\nNormal range in the bloodstream is between 4,500-11,000 WBCs per microliter. \n\nA normal range in the urine is lower than in the blood, and may be from 0-5 white blood cells per high power field (wbc/hpf). Leukocyte ＜5 = normal\n\n ',
      },
      favorite: false,
    };
  }
    ...
    return (
      <SafeAreaView style={styles.screenContainer}>
        ...
        <View style={styles.bottomButtonContainer}>
          <Button onPress={()=>{ Linking.openURL('https://www.healthline.com/health/leukocytes-in-urine')}} title={'Read more information'.toUpperCase()} />
