...
export default class ProductA extends Component {
  constructor(props) {
    ...
    this.state = {
      product: {
        images: [
          require('../../assets/patches/AscorbicAcid/1.png'),
          require('../../assets/patches/AscorbicAcid/2.png'),
          require('../../assets/patches/AscorbicAcid/3.png'),
          require('../../assets/patches/AscorbicAcid/4.png'),
        ],
        name: 'Ascorbic Acid',
        description:
    ...
    return (
      <SafeAreaView style={styles.screenContainer}>
        ...
        <View style={styles.bottomButtonContainer}>
          <Button onPress={()=>{ Linking.openURL('https://ods.od.nih.gov/factsheets/VitaminC-HealthProfessional/')}} title={'Read more information'.toUpperCase()} />
