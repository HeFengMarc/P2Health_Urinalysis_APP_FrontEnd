...
export default class SignUpA extends Component {
  ...
  sendSignup = async uri => {
    let ip = '76.28.196.133';
    let timeUrl = 'http://' + ip + ':5000/signup';
    // var now = Date.now();
  ...
  createAccount = async () => {
    ...
    if (result.status == 0){
      ...
      Alert.alert('This name has been used, please choose another name.');
          ...
          <View style={styles.content}>
            ...
            <View style={styles.form}>
              <UnderlineTextInput
                ...
                onSubmitEditing={this.focusOn(this.userName)}
                returnKeyType="next"
                blurOnSubmit={false}
