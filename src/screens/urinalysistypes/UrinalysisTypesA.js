...
const CALCULATOR_ICON = IOS ? 'ios-calculator' : 'md-calculator';
const EYE_ICON = IOS ? 'ios-eye' : 'md-eye';
const MOBILE_ICON = IOS ? 'ios-camera' : 'md-camera';
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.contentContainerStyle}>
          ...
          <Setting
            onPress={this.navigateTo('UrineDeviceIntro')}
            icon={CALCULATOR_ICON}
            title="Urine Test Device"
          />
          <Divider type="inset" marginLeft={DIVIDER_MARGIN_LEFT} />

          <Setting
            onPress={this.navigateTo('NakedEyesIntro')}
            icon={EYE_ICON}
            title="Naked Eyes"
          />
          <Divider type="inset" marginLeft={DIVIDER_MARGIN_LEFT} />
          ...
          <Setting
            onPress={this.navigateTo('MobileAPPIntro')}
            icon={MOBILE_ICON}
            title="Mobile APP"
          />
          <Divider type="inset" marginLeft={DIVIDER_MARGIN_LEFT} />
